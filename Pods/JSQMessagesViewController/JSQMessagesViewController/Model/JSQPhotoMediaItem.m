...
//resizing media. not in ori project, added this method in
-(CGSize)resizeImage:(JSQPhotoMediaItem*)photoMediaItem
{
    CGSize mediaViewSize = CGSizeMake(500, 500);
    return mediaViewSize;
    return photoMediaItem.mediaViewDisplaySize;
}
